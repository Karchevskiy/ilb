...
import WDSNotesParser.WDSNotesParser;
...
import static ILBprocessing.storage.CachedStorageILB.listLMX;
...
public class MainEntryPoint implements SharedConstants {
    ...
    public static void main(String[] args) {
        WDSNotesParser.mainParserNotes("D:/wdsnewnotes_main.txt");
        preProcessing();
        processing();
        postProcessing();
    }
    ...
    public static void preProcessing() {
        ...
        CatalogueParser.parseLMX();
        System.err.println("LMX size:" + listLMX.size());
    ...
    public static void postProcessing() {
        ...
        System.err.println("success on matching SB9 nodes: " + GlobalPoolOfIdentifiers.resolvedLMX);
    ...
    public static void analyse() {
        for (StarSystem system : storage.sysList) {
            List<ArrayList<String>> collect =
                    system.pairs.stream()
                            .map(z -> z.getParamsForByKey(KeysDictionary.WDSSYSTEM))
