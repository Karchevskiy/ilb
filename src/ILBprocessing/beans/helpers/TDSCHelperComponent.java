 ...
 */
public class TDSCHelperComponent {
    ...
    public TDSCHelperComponent(String s){
    ...
    public static void translateToPairs(ArrayList<TDSCHelperComponent> listComp, ArrayList<NodeTDSC> listPair){
    ...
    public static void propagateToPairNode(NodeTDSC e, TDSCHelperComponent c1){
