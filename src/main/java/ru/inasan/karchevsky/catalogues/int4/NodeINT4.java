...
public class NodeINT4 extends NodeForParsedCatalogue implements Serializable {
    ...
    public NodeINT4(ArrayList<String> sources) throws Exception {
        ...
        if (GlobalPoolOfIdentifiers.isBayer(chameleonID1)) {
        ...
        } else if (GlobalPoolOfIdentifiers.isFlamsteed(chameleonID1)) {
        ...
        } else if (GlobalPoolOfIdentifiers.isDM(chameleonID1)) {
        ...
        } else if (GlobalPoolOfIdentifiers.isDM(idADS)) {
